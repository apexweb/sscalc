...
//        $users = TableRegistry::get('users'); //load model User if you have not already
//        if ($this->Auth->user()) {
...
//        }
    ...
    public function authorize($roles)
    {
        ...
        if ($currentUserRole != 'admin') {
            ...
            //if isAuthorized = true it will do anything, but if it isn't it will redirect to home page with error msg
            if (!$isAuthorized) {
        ...
        try {
            ...
            switch ($type) {
                ...
                case 'installer_order_placed':
                    ...
                    break;
                case 'new_user':
                    $email->subject('Welcome to SMS Screen Management System');
