            ...
            if (!empty($this->request->data['file']['name'])) {
                ...
                if (is_array($parts)) {
                    ...
                    foreach ($parts as $part) {
                        if (isset($part[0]) && !$this->strictEmpty($part[0])) {
                            $entity = $this->Parts->newEntity();
                            $entity->title = isset($part[0]) ? $part[0] : '';
                            $entity->part_number = isset($part[1]) ? $part[1] : '';
                            $entity->supplier = isset($part[2]) ? $part[2] : '';
                            $entity->buy_price_include_GST = isset($part[3]) ? $part[3] : 0;
                            $entity->unit = isset($part[4]) ? $part[4] : '';
                            $entity->size = isset($part[5]) ? $part[5] : 0;
                            $entity->mark_up = isset($part[6]) ? $part[6] : 0;
                            $entity->marked_up = isset($part[7]) ? $part[7] : 0;
                            $entity->price_per_unit = isset($part[8]) ? $part[8] : 0;
                            $entity->description = isset($part[10]) ? $part[10] : '';
