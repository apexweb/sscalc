...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="checkbox checkbox-primary">
            ...
            <?= $this->Form->input('color1', ['type' => 'checkbox', 'class' => 'color_s', 'label' => 'Color 1', 'templates' => [
                'nestingLabel' => '{{hidden}}{{input}}<label{{attrs}}>{{text}}</label>']]) ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="checkbox checkbox-primary">
            ...
            <?= $this->Form->input('color2', ['type' => 'checkbox', 'class' => 'color_s', 'label' => 'Color 2', 'templates' => [
                'nestingLabel' => '{{hidden}}{{input}}<label{{attrs}}>{{text}}</label>']]) ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="checkbox checkbox-primary">
            ...
            <?= $this->Form->input('color3', ['type' => 'checkbox', 'class' => 'color_s', 'label' => 'Color 3', 'templates' => [
                'nestingLabel' => '{{hidden}}{{input}}<label{{attrs}}>{{text}}</label>']]) ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="checkbox checkbox-primary">
            ...
            <?= $this->Form->input('color4', ['type' => 'checkbox', 'class' => 'color_s', 'label' => 'Color 4', 'templates' => [
                'nestingLabel' => '{{hidden}}{{input}}<label{{attrs}}>{{text}}</label>']]) ?>
