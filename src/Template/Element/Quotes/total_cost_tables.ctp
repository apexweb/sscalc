...
<div class="panel panel-default panel-border prices-container col-md-4">
    ...
    <div class="panel-body">
        ...
        <table class="table table-no-border total-cost-table small-padding">
            ...
            <tr>
                <td class="font-bold">Total Sell Price:</td>
                <td>
