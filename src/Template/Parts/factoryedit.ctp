<div class="card-box">
    ...
    <div class="form-group ">
        <div class="col-lg-3 col-md-4 col-xs-12">
            <?= $this->Form->input('marked_up', ['class' => 'form-control input-sm marked-up', 'disabled' => 'disabled']) ?>
        </div>
    </div>

    <div class="form-group ">
        <div class="col-lg-3 col-md-4 col-xs-12">
            <?= $this->Form->input('mark_up', ['class' => 'form-control input-sm markup', 'disabled' => 'disabled']) ?>
        </div>
    </div>
